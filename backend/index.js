...
const withDB = async (operation, res) => {
  try {
    const client = await MongoClient.connect('mongodb+srv://Esmail:asd123@cluster0.a12ny.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
...
app.listen(6000, () => console.log("I am Listening to the port 8000"))
